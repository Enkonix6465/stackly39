...
export default function FashionApparel() {
  const { currentLanguage, t, tArray } = useLanguage();
  return (
    <>
      <Head>
        <title>{t('fashionApparel.pageTitle')}</title>
        <meta name="description" content={t('fashionApparel.pageDescription')} />
      </Head>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="pt-16">
          {/* Hero Section */}
          <VideoBackground videoSrc="/vedios/vedio02.mp4" className="text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 min-h-screen flex items-center justify-center">
              <div className="text-center">
                ...
                >
                  {t('fashionApparel.hero.subtitle')}
                </motion.p>
                <motion.div 
                ...
                >
                  <Link href="#products" className="group bg-gradient-to-r from-indigo-600 to-indigo-700 text-white px-8 py-4 rounded-2xl font-semibold hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    <span className="flex items-center justify-center">
                      <span>{t('fashionApparel.hero.exploreButton')}</span>
                    </span>
                  </Link>
                </motion.div>
              </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                  {t('fashionApparel.featuredCollections.title')}
                </h2>
                <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                  {t('fashionApparel.featuredCollections.subtitle')}
                </p>
              </motion.div>
              ...
              >
                {[
                  {
                    title: t('fashionApparel.featuredCollections.collections.mensWomens.title'),
                    description: t('fashionApparel.featuredCollections.collections.mensWomens.description'),
                    image: "/images/F1.jpg",
                    price: t('fashionApparel.featuredCollections.collections.mensWomens.price')
                  },
                  {
                    title: t('fashionApparel.featuredCollections.collections.kidsFashion.title'),
                    description: t('fashionApparel.featuredCollections.collections.kidsFashion.description'),
                    image: "/images/F2.jpg",
                    price: t('fashionApparel.featuredCollections.collections.kidsFashion.price')
                  },
                  {
                    title: t('fashionApparel.featuredCollections.collections.shoesSneakers.title'),
                    description: t('fashionApparel.featuredCollections.collections.shoesSneakers.description'),
                    image: "/images/F3.jpg",
                    price: t('fashionApparel.featuredCollections.collections.shoesSneakers.price')
                  }
                      ...
                      <div className="relative bg-white dark:bg-gray-800 rounded-3xl m-0.5">
                        ...
                        <div className="p-8">
                          ...
                          <button className="w-full bg-gradient-to-r from-indigo-600 to-indigo-800 text-white py-4 px-6 rounded-2xl font-semibold hover:shadow-xl transition-all duration-300 group-hover:scale-105 text-center block transform hover:-translate-y-1">
                            {t('fashionApparel.featuredCollections.shopCollectionButton')}
                          </button>
                        </div>
                      </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                  {t('fashionApparel.styleFeatures.title')}
                </h2>
                <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                  {t('fashionApparel.styleFeatures.subtitle')}
                </p>
              </motion.div>
              ...
              >
                {[
                  {
                    icon: "👗",
                    title: t('fashionApparel.styleFeatures.features.trendyDesigns.title'),
                    description: t('fashionApparel.styleFeatures.features.trendyDesigns.description')
                  },
                  {
                    icon: "🧵",
                    title: t('fashionApparel.styleFeatures.features.premiumQuality.title'),
                    description: t('fashionApparel.styleFeatures.features.premiumQuality.description')
                  },
                  {
                    icon: "🌈",
                    title: t('fashionApparel.styleFeatures.features.diverseSizes.title'),
                    description: t('fashionApparel.styleFeatures.features.diverseSizes.description')
                  },
                  {
                    icon: "♻️",
                    title: t('fashionApparel.styleFeatures.features.sustainable.title'),
                    description: t('fashionApparel.styleFeatures.features.sustainable.description')
                  }
                ].map((feature, index) => (
                  <motion.div 
                    key={index} 
          ...
          <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                  {t('fashionApparel.fashionCategories.title')}
                </h2>
                <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                  {t('fashionApparel.fashionCategories.subtitle')}
                </p>
              </motion.div>
              ...
              >
                {[
                  {
                    title: t('fashionApparel.fashionCategories.categories.casualWear.title'),
                    items: tArray('fashionApparel.fashionCategories.categories.casualWear.items'),
                    image: "/images/F4.jpg"
                  },
                  {
                    title: t('fashionApparel.fashionCategories.categories.formalAttire.title'),
                    items: tArray('fashionApparel.fashionCategories.categories.formalAttire.items'),
                    image: "/images/F5.jpg"
                  },
                  {
                    title: t('fashionApparel.fashionCategories.categories.accessories.title'),
                    items: tArray('fashionApparel.fashionCategories.categories.accessories.items'),
                    image: "/images/F6.jpg"
                  },
                  {
                    title: t('fashionApparel.fashionCategories.categories.seasonal.title'),
                    items: tArray('fashionApparel.fashionCategories.categories.seasonal.items'),
                    image: "/images/F7.jpg"
                  }
                ].map((category, index) => (
                  <motion.div 
          ...
          <section className="py-20 bg-black text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                  {t('fashionApparel.customerReviews.title')}
                </h2>
                <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                  {t('fashionApparel.customerReviews.subtitle')}
                </p>
              </motion.div>
              ...
              >
                {[
                  {
                    name: t('fashionApparel.customerReviews.testimonials.sarah.name'),
                    role: t('fashionApparel.customerReviews.testimonials.sarah.role'),
                    company: t('fashionApparel.customerReviews.testimonials.sarah.company'),
                    content: t('fashionApparel.customerReviews.testimonials.sarah.content'),
                    avatar: "/images/image15.jpg"
                  },
                  {
                    name: t('fashionApparel.customerReviews.testimonials.michael.name'),
                    role: t('fashionApparel.customerReviews.testimonials.michael.role'),
                    company: t('fashionApparel.customerReviews.testimonials.michael.company'),
                    content: t('fashionApparel.customerReviews.testimonials.michael.content'),
                    avatar: "/images/image16.jpg"
                  },
                  {
                    name: t('fashionApparel.customerReviews.testimonials.emma.name'),
                    role: t('fashionApparel.customerReviews.testimonials.emma.role'),
                    company: t('fashionApparel.customerReviews.testimonials.emma.company'),
                    content: t('fashionApparel.customerReviews.testimonials.emma.content'),
                  ...
                  >
                    <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-800 hover:border-gray-700">
                      ...
                      <div className="text-sm text-gray-400">
                        {t('fashionApparel.customerReviews.verifiedPurchase')}
                      </div>
                    </div>
                  </motion.div>
                ))}
          ...
          <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                {[
                  {
                    number: t('fashionApparel.stats.stats.fashionItems.number'),
                    label: t('fashionApparel.stats.stats.fashionItems.label'),
                    description: t('fashionApparel.stats.stats.fashionItems.description'),
                    icon: "👗",
                    gradient: "from-indigo-500 to-indigo-600"
                  },
                  {
                    number: t('fashionApparel.stats.stats.qualityRate.number'),
                    label: t('fashionApparel.stats.stats.qualityRate.label'),
                    description: t('fashionApparel.stats.stats.qualityRate.description'),
                    icon: "✨",
                    gradient: "from-indigo-500 to-indigo-600"
                  },
                  {
                    number: t('fashionApparel.stats.stats.styleSupport.number'),
                    label: t('fashionApparel.stats.stats.styleSupport.label'),
                    description: t('fashionApparel.stats.stats.styleSupport.description'),
                    icon: "💬",
                    gradient: "from-indigo-500 to-indigo-600"
                  },
                  {
                    number: t('fashionApparel.stats.stats.delivery.number'),
                    label: t('fashionApparel.stats.stats.delivery.label'),
                    description: t('fashionApparel.stats.stats.delivery.description'),
                    icon: "📦",
                    gradient: "from-indigo-500 to-indigo-600"
                  }
                ].map((stat, index) => (
              ...
              <div className="relative z-10">
                ...
                >
                  <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight whitespace-nowrap text-white">
                    {t('fashionApparel.cta.title')} {t('fashionApparel.cta.titleHighlight')}
                  </h2>
                  <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
                    {t('fashionApparel.cta.subtitle')}
                  </p>
                </motion.div>
                ...
                >
                  <div className="inline-block">
                    <Link href="/contact" className="group relative inline-flex items-center px-12 py-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white text-xl font-bold rounded-2xl shadow-2xl hover:shadow-indigo-500/25 transition-all duration-300 hover:scale-105 overflow-hidden">
                      <span className="relative z-10">{t('fashionApparel.cta.shopFashionButton')}</span>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Link href="/services" className="group px-8 py-4 border-2 border-white/30 text-white rounded-xl font-semibold hover:border-white hover:bg-white/10 transition-all duration-300">
                      {t('fashionApparel.cta.viewCategoriesButton')}
                    </Link>
                    <Link href="/contact" className="group px-8 py-4 border-2 border-white/30 text-white rounded-xl font-semibold hover:border-white hover:bg-white/10 transition-all duration-300">
                      {t('fashionApparel.cta.getStyleAdviceButton')}
                    </Link>
                  </div>
                </motion.div>
              </div>
